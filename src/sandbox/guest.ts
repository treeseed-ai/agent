...
export function promptFromContext(context: Record<string, unknown>, reasoningEffort?: string, executionSeconds?: number) {
	...
	const timingStartReminder = 'DO NOT ANSWER OR REASON ABOUT THE TASK YET. Your next action must be the treedx server tool call treeseed_time_status. After completing the task, call treeseed_time_status once more immediately before your response.';
