...
export function researchToKnowledgeNoMutationChain() {
	return runInMemoryMessageChain({
		...
		steps: [
			{ agent: 'treeseed-docs-planner', inputMessageType: 'knowledge_gap_detected', outputMessageTypes: ['research_task_requested'] },
			{ agent: 'treeseed-codebase-cartographer', inputMessageType: 'research_task_requested', outputMessageTypes: ['research_note_created'] },
			{ agent: 'treeseed-knowledge-generator', inputMessageType: 'research_note_created', outputMessageTypes: ['knowledge_draft_created'] },
			{ agent: 'treeseed-knowledge-optimizer', inputMessageType: 'knowledge_draft_created', outputMessageTypes: ['knowledge_optimization_completed', 'promotion_request_created'] },
...
export function governedMutationApprovalChain() {
	return runInMemoryMessageChain({
		...
		steps: [
			{ agent: 'treeseed-docs-engineer', inputMessageType: 'approval_request_approved', outputMessageTypes: ['docs_mutation_completed'] },
			{ agent: 'treeseed-docs-reviewer', inputMessageType: 'docs_mutation_completed', outputMessageTypes: ['review_passed'] },
			{ agent: 'treeseed-workday-reporter', inputMessageType: 'review_passed', outputMessageTypes: ['workday_report_created'] },
			{ agent: 'treeseed-releaser', inputMessageType: 'workday_report_created', outputMessageTypes: ['release_waiting_for_approval'] },
		],
...
export function forbiddenPathFailureChain() {
	return runInMemoryMessageChain({
		...
		initialMessageType: 'approval_request_approved',
		steps: [
			{ agent: 'treeseed-docs-engineer', inputMessageType: 'approval_request_approved', outputMessageTypes: ['docs_mutation_failed'] },
			{ agent: 'treeseed-workday-reporter', inputMessageType: 'docs_mutation_failed', outputMessageTypes: ['workday_report_created'] },
		],
