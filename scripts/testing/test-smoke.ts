...
import type { AgentKernelModeRunTelemetryInput } from '../../src/agents/kernel/agents/agent-kernel.ts';
import type { ExecutionProviderAdapter } from '../../src/agents/runtime/runtime-types.ts';
