...
export const TREESEED_PLATFORM_KNOWLEDGE_QUESTIONS: KnowledgePipelineQuestion[] = [
	...
	},
	{
		...
		targetPath: 'src/content/knowledge/market-ui/mission-control/governance-summary.mdx',
		book: 'market-ui',
		section: 'mission-control',
		contextQueries: [
			{
				id: 'mission-control-governance-summary',
				purpose: 'research',
				query: 'mission control governance approval required verification failed policy violation workday completed',
				scope: '/knowledge',
				codeScopes: ['src/components/app/operations', 'src/pages/app', 'src/pages/v1', 'migrations', 'flow:mission control governance'],
				relations: ['related', 'references'],
				depth: 2,
				budget: 8000,
				format: 'full',
