...
import { loadDeployConfigFromPath } from '@treeseed/sdk/platform/deploy-config';
...
export function resolveExecutionRoot(tenantRoot: string) {
	...
	const deployConfig = loadDeployConfigFromPath(configPath) as { __projectRoot?: string };
