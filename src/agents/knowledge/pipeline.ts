...
export const TREESEED_PLATFORM_KNOWLEDGE_QUESTIONS: KnowledgePipelineQuestion[] = [
	...
	},
	{
		...
		targetPath: 'src/content/knowledge/market-ui/project-agents/governance.mdx',
		book: 'market-ui',
		section: 'project-agents',
		contextQueries: [
			{
				id: 'market-project-agent-governance-ui',
				purpose: 'research',
				query: 'project agents governance UI workday artifacts approvals readiness Market',
				scope: '/knowledge',
				codeScopes: ['src/components/app/project', 'src/pages/app', 'src/pages/v1', 'flow:project agent governance ui'],
				relations: ['related', 'references'],
				depth: 2,
				budget: 8000,
				format: 'full',
	...
	},
	{
		...
		targetPath: 'src/content/knowledge/market-ui/team-inbox/agent-governance.mdx',
		book: 'market-ui',
		section: 'team-inbox',
		contextQueries: [
			{
				id: 'team-inbox-agent-governance',
				purpose: 'research',
				query: 'team inbox governance approval required verification failed policy violation workday completed',
				scope: '/knowledge',
				codeScopes: ['src/components/team', 'src/pages/v1', 'migrations', 'flow:team inbox governance'],
				relations: ['related', 'references'],
				depth: 2,
				budget: 8000,
				format: 'full',
